...
using MyTempProject.Authorization.Impersonation;
using MyTempProject.Authorization.Roles;
using MyTempProject.Authorization.Users;
using MyTempProject.Configuration;
using MyTempProject.Debugging;
using MyTempProject.MultiTenancy;
using MyTempProject.Notifications;
using MyTempProject.Security;
using MyTempProject.Web.Controllers.Results;
using MyTempProject.Web.Models.Account;
using MyTempProject.Web.MultiTenancy;
using Recaptcha.Web;
...
namespace MyTempProject.Web.Controllers
{
    public class AccountController : AbpZeroTemplateControllerBase
    {
        ...
        public ActionResult Login(string userNameOrEmailAddress = "", string returnUrl = "", string successMessage = "",string errorMessage="")
        {
        ...
        public virtual async Task<JsonResult> Login(LoginViewModel loginModel, string returnUrl = "", string returnUrlHash = "")
        {
            ...
            //}
            if (loginResult == null) {
                return Json(new MvcAjaxResponse { Success = false,Error= new Abp.Web.Models.ErrorInfo("用户名或密码输入错误。")});
            }
